INSERT INTO `bronze_terranova.indleaderroute` (unidade, macroprocesso, processo, subarea, usuario, rota, subrota, data, uuid, active, timestamp)
SELECT 
...
WHERE REGEXP_CONTAINS(data, r'rota/indleaderroute:');
